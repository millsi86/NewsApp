...
public class QueryUtils {
    ...
    public static List<Article> fetchArticleData(String requestUrl) {
        ...
        List<Article> articles = extractFeatureFronJson(jsonResponse);
    ...
    private static List<Article> extractFeatureFronJson(String articleJSON) {
        ...
        try {
            ...
            for (int i = 0; i < articleArray.length(); i++) {
                ...
                if (currentArticle.has("webPublicationDate")) {
                    Published = currentArticle.getString("webPublicationDate");
                } else
                    Published = "";
                ...
                for (int j = 0; j < tags.length(); j++) {
                    JSONObject currentTags = tags.getJSONObject(j);

                    if (currentTags.has("webTitle")) {
